...
class CircuitVerifier(object):
    ...
    def eval_mlext(self, lay, z1, z2, w1, w2, w3, v1, v2):
        ...
        # z1, w1, w2 factors
        mlx_z1 = LayerComputeBeta(nOutBits, z1, self.tV_a)
        mlx_w1 = LayerComputeBeta(nInBits, w1, self.tV_a)
        mlx_w2 = LayerComputeBeta(nInBits, w2, self.tV_a)
        ...
        for (out, (in0, in1, typ)) in enumerate(zip(self.in0vv[layN], self.in1vv[layN], self.typvv[layN])):
            ...
            tval = (mlx_z1.outputs[out] * mlx_w1.outputs[in0] * mlx_w2.outputs[in1]) % Defs.prime
